...
/***/ function(module, exports, __webpack_require__) {
	...
	function Cell(props) {
	  ...
	  return React.createElement('div', { style: { width: 100, height: 100, display: 'inline-block', backgroundColor: props.color } });
	}
	...
	function CheckerBoard(pros) {
	  ...
	  for (var i = 0; i < n; i++) {
	    ...
	    for (var j = 0; j < n; j++) {
	      // col
	      if ((i + j) % 2 == 0) {
	        arr.push(React.createElement(Cell, { color: 'red', key: i * n + j })); // when we give array of component, we should give unique key value, otherwise React will complain       
	      } else arr.push(React.createElement(Cell, { color: 'black', key: i * n + j }));
	    }
	...
	var App = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(CheckerBoard, { num: '6' });
	  }
	});
